...
export class InfraStack extends Stack {
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    const hostedZone = route53.HostedZone.fromLookup(this, "PstrHostedZone", {
    ...
    new s3deploy.BucketDeployment(this, "DeployPstrPwa", {
      sources: [s3deploy.Source.asset("../dist")],
      destinationBucket: websiteBucket,
      retainOnDelete: false
    });

    const PstrCertificate = new acm.DnsValidatedCertificate(this, "PstrCert", {
